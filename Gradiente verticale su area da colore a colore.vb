'Script per la colorazione di un'area come gradiente verticale
...
Sub applicaGradienteVerticalePerArea()
...
LInput:
    ...
    firstColor = targetRange.Cells(1, 1).Interior.Color
    firstRed = redMask And firstColor
    firstGreen = greenMask And firstColor
    firstBlue = blueMask And firstColor
    lastColor = targetRange.Cells(targetRowCount, 1).Interior.Color
    ...
    For row = 1 To targetRowCount
        ...
        For column = 1 To targetRange.Columns.Count
